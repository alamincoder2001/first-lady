            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>Bill No:</strong> {{ purchase.PurchaseMaster_BillNo }}<br>
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                ...
                                <tr> 
                                  ...
                                  <td>{{ cart.reduce((prev, curr) => { return prev + +curr.PurchaseDetails_TotalQuantity},0)  }}</td>
                                  <td></td>
                                  <td></td>
                                  <td></td>
                                </tr>
                ...
                <div class="row" style="margin-top:10px;">
                    ...
                    <tbody>
                        <tr style="color: #cd0000" v-for="(product1, sln) in returnCart">
                            <template v-if="returnCart[0].PurchaseReturnDetails_SlNo != null">
                                <td>{{ sln + 1 }}</td>
                                <td style="text-align:left">{{ product1.Product_Name }}</td>
                                <td style="text-align:center">{{ 'Return' }}</td>
                                <td>{{ product1.PurchaseReturnDetails_ReturnQuantity }}</td>
                                <td>{{ product1.PurchaseReturnDetails_ReturnAmount * product1.PurchaseReturnDetails_ReturnQuantity }}</td>
                            </template>
                        </tr>
                        <tr style="font-weight:bold;"> 
                            <td colspan="3" style="text-align:right;"> Total = </td>
                            <td>{{ returnCart.reduce((prev, curr) => { return prev + +curr.PurchaseReturnDetails_ReturnQuantity},0)  }}</td>
                            <td>{{ returnCart.reduce((prev, curr) => { return prev + +(curr.PurchaseReturnDetails_ReturnAmount * curr.PurchaseReturnDetails_ReturnQuantity)},0)  }}</td>
                        </tr>
                    </tbody>
                </table>  
                    </div>
                    <div class="col-xs-5">
                        <table _t92sadbc2>
                            ...
                            <tr>
                              ...
                              <td style="text-align:right">({{ purchase.PurchaseMaster_ReturnAmount }})</td>
                          </tr>
                            <tr>
    ...
    getPurchase() {
      axios
        ...
        .then((res) => {
          ...
          this.purchase.PurchaseMaster_OrderDate = moment(
            this.purchase.PurchaseMaster_OrderDate
          ).format("DD/MM/YYYY");
          this.cart = res.data.purchaseDetails;
          this.returnCart = res.data.purchaseReturn;
        });
    },
    getCurrentBranch() {
    ...
    async print() {
      ...
      printWindow.document.write(`
                ...
                <body>
                    ...
                    <div class="container" style="bottom:15px;width:100%;">
