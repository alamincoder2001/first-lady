...
class Account extends CI_Controller
{
    ...
    public function addCashTransaction()
    {
        ...
        try {
            ...
            unset($transaction['In_Amount']);
            unset($transaction['Out_Amount']);
            $transaction['In_Amount'] = $transactionObj->In_Amount != '' ? $this->mt->convert($transactionObj->In_Amount) : '';
            $transaction['Out_Amount'] = $transactionObj->Out_Amount != '' ? $this->mt->convert($transactionObj->Out_Amount) : '';
    ...
    function getOtherIncomeExpense()
    {
        ...
        if (isset($data->customer) && $data->customer != '') {
            $returnClause_CId = " and sm.SalseCustomer_IDNo = '$data->customer'";
        }
    ...
    public function addBankAccount()
    {
        ...
        try {
            ...
            $accountCheck = $this->db->query("SELECT * from tbl_bank_accounts where account_number = ?", $data->account_number)->num_rows();
            ...
            $account['initial_balance'] = $this->mt->convert($data->initial_balance);
    ...
    public function addBankTransaction()
    {
        ...
        try {
            ...
            $transaction['amount'] = $this->mt->convert($data->amount);
        ...
        $transactions = $this->db->query("
            select * from(
                ...
                select
                    ...
                    concat('Sale received - ', c.Customer_Name, ' (', c.Customer_Code, ')') as description, 
                    sm.account_id,
                ...
                select
                    ...
                    concat('Purchase payment - ', s.Supplier_Name, ' (', s.Supplier_Code, ')') as description, 
                    pm.account_id,
