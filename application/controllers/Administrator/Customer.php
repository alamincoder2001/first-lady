...
class Customer extends CI_Controller
{
    ...
    public function addCustomerPayment()
    {
        ...
        try {
            ...
            unset($payment['CPayment_amount']);
            unset($payment['CPayment_discount']);
            $payment['CPayment_amount']   = $this->mt->convert($paymentObj->CPayment_amount);
            $payment['CPayment_discount'] = $this->mt->convert($paymentObj->CPayment_discount);
    ...
    public function addCustomer()
    {
        ...
        try {
            ...
            unset($customer['previous_due']);
            unset($customer['Customer_Credit_Limit']);
            $customer['previous_due'] = $this->mt->convert($customerObj->previous_due);
            $customer['Customer_Credit_Limit'] = $this->mt->convert($customerObj->Customer_Credit_Limit);
    ...
    function getCustomerLedger()
    {
        ...
        $payments = $this->db->query("
            select 
                ...
                sm.SaleMaster_ReturnAmount as returned,
