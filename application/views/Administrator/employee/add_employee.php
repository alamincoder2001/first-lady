		...
		<div class="form-horizontal">
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					...
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-6">
						<input class="form-control date-picker" name="em_Joint_date" id="em_Joint_date" type="text" data-date-format="dd/mm/yyyy" style="border-radius: 5px !important;" value="<?php echo date("d/m/Y") ?>" />
					</div>
				</div>
		...
		<div class="form-horizontal">
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					...
					<label class="col-sm-1 control-label">:</label>
					<div class="col-sm-6">
						<input class="form-control date-picker" name="em_dob" id="em_dob" type="text" data-date-format="dd/mm/yyyy" style="border-radius: 5px !important;" value="<?php echo date("d/m/Y") ?>" />
					</div>
				</div>
