                    ...
                    <tbody>
                        <template v-for="sale in sales">
                            <tr>
                                ...
                                <td>{{ moment(sale.SaleMaster_SaleDate).format('DD/MM/YYYY') }}</td>
                ...
                <table class="record-table"
                    ...
                    <tbody>
                        <tr v-for="sale in sales">
                            <td>{{ sale.SaleMaster_InvoiceNo }}</td>
                            <td>{{ sale.SaleMaster_Bill_no }}</td>
                            <td>{{ moment(sale.SaleMaster_SaleDate).format('DD/MM/YYYY') }}</td>
                            <td>{{ sale.Customer_Name }}</td>
                            <td>{{ sale.Employee_Name }}</td>
                            <td>{{ sale.AddBy }}</td>
                            <td style="text-align:right;">{{ sale.SaleMaster_SubTotalAmount }}</td>
                            <td style="text-align:right;">{{ sale.SaleMaster_ReturnAmount }}</td>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                {{ sales.reduce((prev, curr)=>{return prev + parseFloat(curr.SaleMaster_ReturnAmount)}, 0) }}
                            </td>
                            <td style="text-align:right;">
                            ...
                            <td style="text-align:right;">
                                {{ sales.reduce((prev, curr)=>{return prev + parseFloat(curr.qty)}, 0) }}</td>
                            <td></td>
                            <td></td>
                        </tr>
                    </tfoot>
