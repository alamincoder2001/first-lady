                ...
                <div class="row">
                    <div class="col-md-5 col-md-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-1">:</label>
                            <div class="col-md-7">
                                <select class="form-control" required v-model="transaction.Tr_Type"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-xs-11">
                                ...
                                <v-select v-bind:options="accounts" v-model="selectedAccount" label="Acc_Name"
                                    v-if="accounts.length > 0"></v-select>
                            </div>
...
new Vue({
    ...
    methods: {
        ...
        editTransaction(transaction) {
            ...
            this.transaction.In_Amount = transaction.In_Amount * 100;
            this.transaction.Out_Amount = transaction.Out_Amount * 100;
