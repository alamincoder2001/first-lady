				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" class="form-control" v-model="payment.SPayment_discount" required>
							</div>
						</div>
						<div class="form-group">
	...
	new Vue({
		...
		methods: {
			...
			saveSupplierPayment() {
				...
				let conf = confirm('Are you sure to save transaction?');
				if (conf) {
			...
			editPayment(payment) {
				...
				this.payment.SPayment_amount = this.payment.SPayment_amount * 100
				this.payment.SPayment_discount = this.payment.SPayment_discount * 100
			},
			...
			resetForm() {
				...
				this.payment.SPayment_amount = 0;
				this.payment.SPayment_discount = 0;
