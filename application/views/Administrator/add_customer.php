...
new Vue({
    ...
    methods: {
        ...
        saveCustomer() {
            ...
            let conf = confirm('Are you sure to ' + msg + ' this customer')
        ...
        editCustomer(customer) {
            let conf = confirm('Are you sure to edit the customer?')
            if (conf) {
                let keys = Object.keys(this.customer);
                keys.forEach(key => {
                    this.customer[key] = customer[key];
                    this.customer.Customer_Credit_Limit = customer.Customer_Credit_Limit * 100;
                    this.customer.previous_due = customer.previous_due * 100;
