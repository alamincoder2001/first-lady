...
<div class="row" id="purchase">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" placeholder="Bill no" v-model="purchase.Bill_no" />
                </div>
            </div>

            <div class="form-group">
                <label class="col-sm-1 control-label no-padding-right"> Purchase For </label>
                <div class="col-sm-2">
    ...
    <div class="col-xs-12 col-md-9 col-lg-9">
                    ...
                    <tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
                        ...
                        <tr style="font-weight: bold">
                            ...
                            <td style="text-align:center">
                                {{ cart.reduce((prev,curr)=> {return prev + +curr.quantity},0) }} </td>
        ...
        <div class="row">
            <div class="col-12">
                <input type="checkbox" id="isReturn" value="isReturn" v-model="isReturn"> <label for="isReturn">is
                    Return</label>
            </div>
                                ...
                                <div class="col-sm-5">
                                    <form v-on:submit.prevent="addToCartReturn">
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-xs-9">
                                                <v-select id="returnProduct" v-bind:options="returnProducts"
                                                    v-model="selectedReturnProduct" label="display_text"
                                                    v-on:input="returnProductOnChange"></v-select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-xs-9">
                                                <input type="number" id="salesRate" placeholder="Rate" step="0.01"
                                                    class="form-control" ref="rate"
                                                    v-model="selectedReturnProduct.Product_Purchase_Rate"
                                                    v-on:input="productReturnTotal" />
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                            <label class="col-xs-3 control-label no-padding-right"> Quantity </label>
                                            <div class="col-xs-9">
                                                <input type="number" step="0.01" id="returnQuantity" placeholder="Qty"
                                                    class="form-control" ref="returnQuantity"
                                                    v-model="selectedReturnProduct.quantity"
                                                    v-on:input="productReturnTotal" autocomplete="off" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-xs-9">
                                                <input type="text" id="productTotal" placeholder="Amount"
                                                    class="form-control" v-model="selectedReturnProduct.total"
                                                    readonly />
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
                                            ...
                                            <tbody style="display:none;"
                                                v-bind:style="{display: returnCart.length > 0 ? '' : 'none'}">
                                                <tr v-for="(product, sl) in returnCart">
                                                    ...
                                                    <td>{{ product.purchaseRate }}</td>
                                                    <td>{{ product.total }}</td>
                                                    <td><a href="" v-on:click.prevent="removeFromReturnCart(sl)"><i
                                                ...
                                                <tr style="font-weight: bold">
                                                    ...
                                                    <td style="text-align:center">
                                                        {{ returnCart.reduce((prev,curr)=> {return prev + +curr.quantity},0) }}
                                                    </td>
                                                    <td style="text-align:center"></td>
                                                    <td style="text-align:center"></td>
                                                    <td style="text-align:center"></td>
                                                ...
                                                <tr>
                                                    <td colspan="3"><textarea style="width: 100%;font-size:13px;"
                                                            placeholder="Note" v-model="purchase.returnNote"></textarea>
                                                    </td>
                                                    <td colspan="3" style="padding-top: 15px;font-size:18px;">
                                                        {{ returnCart.reduce((prev,curr)=> {return prev + +curr.total},0) }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <label class="col-xs-12 control-label no-padding-right">Return
                                                    Total</label>
                                                <div class="col-xs-12">
                                                    <input type="number" id="returnTotal" class="form-control"
                                                        v-model="purchase.returnTotal" readonly />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <select name="payment_type" id="payment_type" class="form-control"
                                                        v-model="purchase.payment_type" style="padding: 1px;">
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label no-padding-right">Bank
                                                    Account</label>
                                                <div class="col-sm-12">
                                                    <v-select v-bind:options="accounts" v-model="account"
...
new Vue({
    ...
    methods: {
        ...
        productReturnTotal() {
            this.selectedReturnProduct.total = (parseFloat(this.selectedReturnProduct.quantity) * parseFloat(
                this.selectedReturnProduct.Product_Purchase_Rate)).toFixed(2);
        },
        addToCart() {
        ...
        addToCartReturn() {
            ...
            if (product.Product_Purchase_Rate == 0 || product.Product_Purchase_Rate == '') {
        ...
        calculateTotal() {
            ...
            this.purchase.returnTotal = returnAmount;
            ...
            let pTotal = ((parseFloat(this.purchase.subTotal) + parseFloat(this.purchase.vat) + parseFloat(this
                .purchase.freight) / 100) - parseFloat(this.purchase.discount) / 100).toFixed(2);

            this.purchase.total = (pTotal - returnAmount).toFixed(2)

            if (this.selectedSupplier.Supplier_Type == 'G') {
                this.purchase.paid = this.purchase.total * 100;
                this.purchase.due = 0;
            } else {
                ...
                this.purchase.due = (parseFloat(this.purchase.total) - parseFloat(this.purchase.paid) / 100)
                    .toFixed(2);
            }
        },
        savePurchase() {
            ...
            if (this.purchase.payment_type == '') {
                alert('Select a Payment Type');
                return;
            }
            if (this.purchase.payment_type == 'bank' && this.account.account_id == '') {
            ...
            this.purchase.discount = this.purchase.discount / 100;
            this.purchase.freight = this.purchase.freight / 100;
            this.purchase.paid = this.purchase.paid / 100;
            ...
            let conf = confirm('Are you sure to save purchase?');
            if (conf) {
        ...
        async getPurchase() {
            await axios.post('/get_purchases', {
                ...
                this.purchase.Bill_no = purchase.PurchaseMaster_BillNo;
                ...
                this.purchase.returnTotal = purchase.PurchaseMaster_ReturnAmount;
                this.purchase.vat = purchase.PurchaseMaster_Tax;
                this.purchase.discount = purchase.PurchaseMaster_DiscountAmount * 100;
                this.purchase.freight = purchase.PurchaseMaster_Freight * 100;
                this.purchase.total = purchase.PurchaseMaster_TotalAmount;
                this.purchase.paid = purchase.PurchaseMaster_PaidAmount * 100;
                ...
                if (r.purchaseReturn.length > 0) {
                    r.purchaseReturn.forEach(rProduct => {
                        let rCartProduct = {
                            productId: rProduct.PurchaseReturnDetailsProduct_SlNo,
                            productCode: rProduct.Product_Code,
                            name: rProduct.Product_Name,
                            salesRate: rProduct.Product_SellingPrice,
                            // vat: this.selectedReturnProduct.vat,
                            quantity: rProduct.PurchaseReturnDetails_ReturnQuantity,
                            total: rProduct.PurchaseReturnDetails_ReturnAmount,
                            purchaseRate: parseFloat(rProduct
                                .PurchaseReturnDetails_ReturnAmount) / parseFloat(
                                rProduct.PurchaseReturnDetails_ReturnQuantity)
                        }

                        this.returnCart.push(rCartProduct);
                    })
                    this.isReturn = true;
                }

                if (purchase.payment_type == 'bank') {
                    this.account = this.accounts.find(item => item.account_id == purchase
                        .account_id);
                }
