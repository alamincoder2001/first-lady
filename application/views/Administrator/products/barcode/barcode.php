...
<html>
    <head>
        ...
        <style type="text/css">
		   ...
		   .name{height:auto;width:120px;font-size:10px;}
            ...
            <div class="output col-md-8 col-md-offset-2">
                <section class="output">
					...
					?>
						...
						<div style="padding: 2px; float: left; height: 102.5px; width: 210px; border: 1px solid #ddd;">
							<div style="width: 210px; text-align: center; float: right;">
								<span class="article" style="font-size: 10px;"><?php echo $article; ?></span>
								<span  style="font-size: 10px; text-align: center"><?php echo $pname; ?></span>
								<img src='<?php echo site_url();?>GenerateBarcode/<?php echo $PID;?>' style="height: 60px; width: 175px;" /><br>
