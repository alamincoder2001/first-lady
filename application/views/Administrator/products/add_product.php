	...
	new Vue({
		...
		methods: {
			...
			editProduct(product) {
				...
				this.product.Product_Purchase_Rate = this.product.Product_Purchase_Rate * 100;
				this.product.Product_SellingPrice = this.product.Product_SellingPrice * 100;
				this.product.Product_WholesaleRate = this.product.Product_WholesaleRate * 100;
			},
